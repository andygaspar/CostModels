...
# print(os.getcwd())
cost_fun = get_cost_model(aircraft_type="A320", airline="fhjd", destination="EGLL", n_passengers=170, length=800)
cost_fun_mc = get_cost_model(aircraft_type="A320", airline="fhjd", destination="EGLL", n_passengers=170, length=800,
                             missed_connected=[(20, 300), (40, 200), (25, 185)])
cost_fun_mc_1 = get_cost_model(aircraft_type="A320", airline="fhjd", destination="EGLL", n_passengers=170, length=800,
